    ...
    },
    {
      'cases': [
        ...
        },
        {
          ...
          >>> s0, s1 = hog.play(always(1), always(1), goal=20, dice=hog.make_test_dice(6, 1, 5, 3, 1, 10, 7), feral_hogs=False)
          >>> s0
          12
          >>> s1
          21
        ...
        },
        {
          ...
          >>> s0, s1 = hog.play(always(1), always(4), score0=39, score1=96, dice=always_two, feral_hogs=False)
          >>> s0
          104
          >>> s1
          41
